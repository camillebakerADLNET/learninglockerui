...
export default connect(state => ({
  route: createRouteNodeSelector('admin')(state).route,
  users: createRouteNodeSelector('admin.data')(state).route,
  organisations: createRouteNodeSelector('admin.organisations')(state).route,
}), {})(render);
