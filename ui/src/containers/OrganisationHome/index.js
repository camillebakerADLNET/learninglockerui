...
export default connect(
  state => ({
    route: createRouteNodeSelector('organisation')(state).route,
    data: createRouteNodeSelector('organisation.data')(state).route,
    people: createRouteNodeSelector('organisation.people')(state).route,
    settings: createRouteNodeSelector('organisation.settings')(state).route,
  })
)(organisationHome);
