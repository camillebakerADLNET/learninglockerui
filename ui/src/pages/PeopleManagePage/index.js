...
export default connect(
  state => ({
    ...
    params: createRouteNodeSelector('organisation.people.manage')(state).route.params,
    personaId: createRouteNodeSelector('organisation.people.manage.persona')(state).route.params.personaId
  }),
  { addModel }
)(PersonaManage);
