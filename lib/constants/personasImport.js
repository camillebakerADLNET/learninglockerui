...
export const COLUMN_ATTRIBUTE_DATA_KEY = 'COLUMN_ATTRIBUTE_DATA_KEY';
export const COLUMN_IFI_KEY = 'COLUMN_IFI_KEY';
export const COLUMN_IFI_VALUE = 'COLUMN_IFI_VALUE';
